...
adhd_hic_genes = list(line.strip() for line in open("ADHD_hic_genes.txt"))
anx_hic_genes = list(line.strip() for line in open("Anx_hic_genes.txt"))
bd_hic_genes = list(line.strip() for line in open("BD_hic_genes.txt"))
ud_hic_genes = list(line.strip() for line in open("UD_hic_genes.txt"))
scz_hic_genes = list(line.strip() for line in open("SCZ_hic_genes.txt"))
cog_hic_genes = list(line.strip() for line in open("Cognition_hic_genes.txt"))

f = open('hic_egenes_statistics.txt', 'w')
...
# Rangom lists of genes:
    ...
    adhd = set(np.random.choice(adhd_hic_genes, 225, replace= True))
    anx = set(np.random.choice(anx_hic_genes, 466, replace= True))
    bd = set(np.random.choice(bd_hic_genes, 395, replace= True))
    ud = set(np.random.choice(ud_hic_genes, 1094, replace= True))
    sch = set(np.random.choice(scz_hic_genes, 1316, replace= True))
    cog = set(np.random.choice(cog_hic_genes, 1173, replace= True))
    ...
    if  (len_adhd_anx_bd_ud_sch_cog >= 33):
        temp.append(1)
    else:
        pass
    if (len_adhd_anx_bd_ud_sch >= 49):
        temp.append(2)
    else:
        pass
    if (len_adhd_anx_sch_ud_cog >= 34):
        temp.append(3)
    else:
        pass
    if (len_adhd_bd_sch_ud_cog >= 42):
        temp.append(4)
    else:
        pass
    if (len_anx_bd_sch_ud_cog >= 36):
        temp.append(5)
    else:
        pass
    if (len_adhd_anx_bd_ud_cog >= 33):
        temp.append(6)
    else:
        pass
    if (len_adhd_anx_bd_sch_cog >= 33):
        temp.append(7)
    else:
        pass
    if (len_adhd_bd_sch_ud >= 140):
        temp.append(8)
    else:
        pass
    if (len_anx_bd_ud_cog >= 36):
        temp.append(9)
    else:
        pass
    if (len_anx_sch_ud_cog >= 51):
        temp.append(10)
    else:
        pass
    if (len_bd_sch_ud_cog >= 50):
        temp.append(11)
    else:
        pass
    if (len_anx_bd_sch_cog >= 37):
        temp.append(12)
    else:
        pass
    if (len_anx_bd_sch_ud >= 56):
        temp.append(13)
    else:
        pass
    if (len_adhd_sch_ud_cog >= 45):
        temp.append(14)
    else:
        pass
    if (len_adhd_bd_ud_cog >= 42):
        temp.append(15)
    else:
        pass
    if (len_adhd_bd_sch_cog >= 42):
        temp.append(16)
    else:
        pass
    if (len_adhd_anx_ud_cog >= 34):
        temp.append(17)
    else:
        pass
    if (len_adhd_anx_sch_cog >= 34):
        temp.append(18)
    else:
        pass
    if (len_adhd_anx_sch_ud >= 50):
        temp.append(19)
    else:
        pass
    if (len_adhd_anx_bd_cog >= 33):
        temp.append(20)
    else:
        pass
    if (len_adhd_anx_bd_ud >= 49):
        temp.append(21)
    else:
        pass
    if (len_adhd_anx_bd_sch >= 49):
        temp.append(22)
    else:
        pass
    if (len_anx_bd_sch >= 58):
        temp.append(23)
    else:
        pass
    if (len_adhd_sch_ud >= 150):
        temp.append(24)
    else:
        pass
    if (len_anx_sch_ud >= 90):
        temp.append(25)
    else:
        pass
    if (len_bd_sch_ud >= 167):
        temp.append(26)
    else:
        pass
    if (len_bd_sch_cog >= 58):
        temp.append(27)
    else:
        pass
    if (len_anx_ud_cog >= 94):
        temp.append(28)
    else:
        pass
    if (len_sch_ud_cog >= 104):
        temp.append(29)
    else:
        pass
    if (len_bd_ud_cog >= 50):
        ...
        pass
    if (len_anx_sch_cog >= 72):
        temp.append(31)
    else:
        pass
    if (len_anx_bd_cog >= 37):
        temp.append(32)
    else:
        pass
    if (len_anx_bd_ud >= 57):
        ...
        pass
    if (len_adhd_ud_cog >= 46):
        temp.append(34)
    else:
        pass
    if (len_adhd_sch_cog >= 49):
        temp.append(35)
    else:
        pass
    if (len_adhd_bd_cog >= 44):
        temp.append(36)
    else:
        pass
    if (len_adhd_bd_ud >= 140):
        temp.append(37)
    else:
        pass
    if (len_adhd_bd_sch >= 140):
        temp.append(38)
    else:
        pass
    if (len_adhd_anx_cog >= 34):
        temp.append(39)
    else:
        pass
    if (len_adhd_anx_ud >= 50):
        temp.append(40)
    else:
        pass
    if (len_adhd_anx_sch >= 50):
        temp.append(41)
    else:
        pass
    if (len_adhd_anx_bd >= 49):
        temp.append(42)
    else:
        pass
    if (len_adhd_anx >= 51):
...
f1 = open('hic_egenes_pvalues.txt', 'w')
