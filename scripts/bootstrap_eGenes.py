...
allgene = list(line.strip() for line in open("data/eGenes/all_genes.txt"))
f = open('statistics_egenes.txt', 'w')
...
# Rangom lists of genes:
    ...
    adhd = set(np.random.choice(allgene, 225, replace= True))
    anx = set(np.random.choice(allgene, 466, replace= True))
    bd = set(np.random.choice(allgene, 395, replace= True))
    ud = set(np.random.choice(allgene, 1094, replace= True))
    sch = set(np.random.choice(allgene, 1316, replace= True))
    cog = set(np.random.choice(allgene, 1173, replace= True))
